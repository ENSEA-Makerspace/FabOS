...
**Last updated:** 2026-07-31 (S21–S31, S37, S45, S46, S47/S48/S49 (partial), S50, S54, S55; Phase H planned, Phase U under way) · **Branch:** `fix/creation-upload-duration-and-image` · **Live:** https://fabos.dstei.fr, running `APP_ENV=prod` since 2026-07-30
...
- ⚠️ **`importmap()` is called in zero templates, so AssetMapper never loads and Stimulus/Turbo run nowhere.** Both bundles are installed and completely inert. Reach for native HTML (`<details>`, `<dialog>`) until S51 wires the front-end up deliberately — and note that enabling Turbo means it starts intercepting every navigation, which is not a side change.

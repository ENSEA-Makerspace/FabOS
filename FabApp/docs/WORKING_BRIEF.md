...
- Latest delivery is **S108**: profile preference and shared `?location=` display context are live for machines, spaces and events; the preference never authorizes access. Next substantive session: **S109**, protected local groups. All authorization changes stay in shadow mode before activation.

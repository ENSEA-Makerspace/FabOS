...
- Latest delivery is **S110**: Use/Manage grant primitives and AND-scopes exist only in shadow mode; Manage includes reporting/export and never Use. Next substantive session: **S111**, persisted packages and group assignments. All authorization changes stay in shadow mode before activation.

...
- Latest delivery is **S109**: the seven protected group/audience descriptors now have stable keys while existing security roles remain compatible. Next substantive session: **S110**, Use/Manage grants in shadow mode. All authorization changes stay in shadow mode before activation.

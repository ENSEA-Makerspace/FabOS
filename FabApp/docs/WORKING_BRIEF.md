...
- Latest delivery is **S104**: quota counters are scoped by `ReservableType`; an access pass bypasses soft quotas only, never alignment or resource buffer. Next substantive session: **S105**, portal consolidation report. All authorization changes stay in shadow mode before activation.

...
- Product decisions still required are listed explicitly in `USAGE_RIGHTS_VISION.md` (Admin safety, Guest events, Trainer migration, institutions, public-profile surfaces, IdP session revocation and domain cardinalities). Pool booking and physical-card enforcement are deferred and do not block S103–S128.

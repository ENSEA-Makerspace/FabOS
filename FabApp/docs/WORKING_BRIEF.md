...
- Latest delivery is **S105**: portals are frozen and `/admin/portals/consolidation` inventories hostname, settings, features and packages without data loss. Next substantive session: **S106**, default sub-location. All authorization changes stay in shadow mode before activation.

...
🔴 **Prochaine étape : le CONTRACT**, et il demande une décision — après le
contract, un rôle donné doit-il encore inscrire dans le groupe, ou les deux
divergent-ils ? Plan complet dans `ROADMAP.md` § « Phase S158 ».

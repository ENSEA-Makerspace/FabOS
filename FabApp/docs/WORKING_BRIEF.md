...
- Product decisions still required are listed explicitly in `USAGE_RIGHTS_VISION.md`: Admin recovery versus physical safety, whether Manage implies Report, localization of future training sessions, existing public-profile surfaces, and active-session lifetime after IdP disablement. Pool booking and physical-card enforcement are deferred and do not block S103–S128.

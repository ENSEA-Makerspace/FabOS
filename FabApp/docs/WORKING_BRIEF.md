...
- Latest delivery is **S107**: machines, spaces and loanable items are backfilled to `Venue/default`; on-site events use it while external events remain unscoped. Loans and RFID readers inherit their resource scope. Next substantive session: **S108**, preferred venue/profile context. All authorization changes stay in shadow mode before activation.

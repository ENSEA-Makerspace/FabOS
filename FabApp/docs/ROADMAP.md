...
⬅️ **Next on the admin: the five list pages still on the old skeleton** — badges, formations, machines, reservations, utilisateurs. They need their four nested wrappers unwound rather than lifted, which is why they were not done with the other nine.

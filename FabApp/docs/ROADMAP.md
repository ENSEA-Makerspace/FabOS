...
⬅️ **Next on the admin: put the list PAGES on a shared shell**, the way `_catalogue.html.twig` did for the public side. S82 unified the furniture (button, filter bar, table); the layout around it is still per-page.
